...
import { BMAD_GUIDELINES } from '../../bmad/guidelines.js';
...
<!-- 
🤖 AGENT INSTRUCTIONS (PRODUCT OWNER ROLE)
${BMAD_GUIDELINES.product_owner}
${BMAD_GUIDELINES.planning}
-->
...
<!-- 
🤖 AGENT INSTRUCTIONS (ARCHITECT ROLE)
${BMAD_GUIDELINES.architecture}
${BMAD_GUIDELINES.security}
-->
...
<!-- 
🤖 AGENT INSTRUCTIONS (SCRUM MASTER ROLE)
${BMAD_GUIDELINES.scrum_master}
-->
